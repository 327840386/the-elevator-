...
public class BuildingReport {
  ...
  public String toString() {
    ...
    for (int i = 0; i < elevatorReports.length; i++) {
      sb.append("    Elevator ").append(i + 1).append(": ").append(elevatorReports[i]).append("\n");
    }

    sb.append("  Up Requests: ").append(upRequests).append("\n");
    sb.append("  Down Requests: ").append(downRequests).append("\n");
